...
def test_apply():
    ...
    mutations[('B',2)] = [mut.Mutation(orig='A', target='C', chain_id='B', res_num=10), mut.Mutation(orig='C', target='A', chain_id='B', res_num=10)]
    mutations[('B',3)] = [mut.Mutation(orig='R',target='H',chain_id='B', res_num=10), mut.Mutation(orig='R',target='A',chain_id='B', res_num=10),mut.Mutation(orig='A',target='R',chain_id='B', res_num=10)]
    mr.lock_chain('A')
    mr.lock_residue(('B',1))
    ...
    assert mutations[('B',2)] == [mut.Mutation(orig='C', target='A', chain_id='B', res_num=10)]
    assert mutations[('B',3)] == [mut.Mutation(orig='R', target='H', chain_id='B', res_num=10)]
