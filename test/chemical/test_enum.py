...
def test_enum_value_comparisons():
    ...
    assert renum.ResidueType.CANONICAL < renum.ResidueType.MODIFIED
    assert renum.ResidueType.MODIFIED < renum.ResidueType.SOLVENT
...
def test_converstion_to_integer():
    ...
    assert int(renum.ResidueType.MODIFIED) == 1
...
def test_conversion_from_integer():
    ...
    assert renum.ResidueType(1) == renum.ResidueType.MODIFIED
...
def test_residue_type_mapper():
    ...
    assert renum.RESIDUE_TYPE_MAPPER[renum.ResidueType(1)] == "MODIFIED"
