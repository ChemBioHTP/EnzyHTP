...
def test_same_sequence_equal():
    ...
    residues = [Residue("A.A.1",list()),Residue("A.A.2",list()),Residue("A.B.3",list()),Residue("A.D.5",list())]
    ...
    residues_alt = [Residue("B.A.1",list()),Residue("B.A.2",list()),Residue("B.B.3",list()),Residue("B.D.5",list())]
...
def test_same_sequence_not_equal():
    ...
    residues_alt1 = [Residue("A.B.1",list()),Residue("A.A.2",list()),Residue("A.B.3",list()),Residue("A.D.5",list())]
    chain3 = Chain("A", residues_alt1 )
    assert not chain3.same_sequence( chain1 )
    assert not chain3.same_sequence( chain1 )


    residues_alt2 = [Residue("A.A.3",list()),Residue("A.A.2",list()),Residue("A.B.3",list()),Residue("A.D.5",list())]
