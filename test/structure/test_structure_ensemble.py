...
def test_structures():
    ...
    answer = [
        ([32.586, 55.789, 30.602], [39.661, 27.409, 36.51]),
        ([34.88, 53.201, 22.495], [36.392, 27.392, 38.547]),
        ([37.41, 54.562, 25.501], [35.305, 27.228, 38.266]),
        ([27.814, 51.521, 21.567], [37.699, 30.371, 39.822]),
        ([30.507, 43.798, 13.187], [35.46, 35.527, 40.971]),
        ([30.84, 19.298, 14.47], [35.6, 39.992, 38.233]),
        ([29.9, 19.785, 17.46], [36.833, 40.408, 37.839]),
        ([29.248, 19.402, 17.4], [38.487, 38.876, 37.831]),
        ([25.089, 14.023, 21.701], [36.193, 41.793, 35.419]),
        ([22.332, 17.39, 19.672], [38.004, 39.988, 36.79]),
