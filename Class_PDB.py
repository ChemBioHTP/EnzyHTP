...
'''        
    ...
    def PDB2QMMM(self, o_dir='',tag='', work_type='spe', qm='g16', keywords='', prmtop_path=None, spin_list=[1,1]):
        '''
        ...
        *om_lvl     : *(can only be edit manually before loading the module) oniom method level
        ...
        if qm == 'g16':
            ...
            coord = self._get_oniom_g16_coord(prmtop_path)
        ...
        for lig in self.stru.ligands:
            for atom in lig:
                ...
                if atom.id in self.layer[0]:
                    ...
                    coord += atom.build_oniom('l', self.chrg_list_all[atom.id-1], if_lig=1)
        ...
        for sol in self.stru.solvents:
            for atom in sol:
                ...
                if atom.id in self.layer[0]:
                    ...
                    coord += atom.build_oniom('l', self.chrg_list_all[atom.id-1], if_sol=1)
