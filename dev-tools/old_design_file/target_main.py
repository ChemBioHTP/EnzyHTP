...
def mutant_design_workflow(stru_parser: StructureParser):
    ...
    preparer.delete_problem(
        'stoichiometry')  # one can edit the method of dealing with different problems
...
def mutant_design_workflow_w_object(parser, preparer, muta_flags, mutator, sampler,
                                    energy_engine, ranker):
    '''
