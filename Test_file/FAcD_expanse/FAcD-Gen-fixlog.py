...
def main():
	...
	for i in range(4):
		...
		pdb_obj.rm_wat()
		of.write('Preparation: '+str(datetime.datetime.now()- starttime)+line_feed)													# Remove water and ion in original crystal file 											(self.path) 
		...
		of.write('Mutation: p2pwl: '+str(datetime.datetime.now()- starttime)+line_feed)													# Remove water and ion in original crystal file 											(self.path) 
		...
		if exit_code == 1:
			continue
		of.write('Mutation: PDBMin: '+str(datetime.datetime.now()- starttime)+line_feed)													# Remove water and ion in original crystal file 											(self.path) 
		...
		of.write('QM Cluster: '+str(datetime.datetime.now()- starttime)+line_feed)													# Remove water and ion in original crystal file 											(self.path) 
		...
		of.write('Get field strength: '+str(datetime.datetime.now()- starttime)+line_feed)													# Remove water and ion in original crystal file 											(self.path) 
		# Bond Dipole Moment (QM)
		Dipoles = PDB.get_bond_dipole(pdb_obj.qm_cluster_fchk, a1qm, a2qm)	# Run Bond Dipole Moment analysis
		of.write('Get bond dipole: '+str(datetime.datetime.now()- starttime)+line_feed)													# Remove water and ion in original crystal file 											(self.path) 
		# Mutation distance
		...
		of.write(Muta_tag+ ' finish: '+str(datetime.datetime.now()- starttime)+line_feed)													# Remove water and ion in original crystal file 											(self.path) 
		of.close()
