...
from enzy_htp.structure import PDBParser, Structure, Ligand, Cavity, Mol2Parser, Chain
...
def _place_mole2(stru: Structure,
    ...
    cavities: List[Cavity] = interface.mole2.identify_cavities(stru, work_dir=work_dir)

    seed_locations:List = list()
    for cavity in cavities:
        vert_matrix = np.array(cavity.points)
