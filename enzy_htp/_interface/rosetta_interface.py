...
from .handle_types import ddGFoldEngine, ddGResultEgg, ModelingResultEgg, ModelingEngine
...
class RosettaInterface(BaseInterface):
    ...
    def run_rscripts(self, stru: Structure, protocol:RosettaScriptsProtocol, opts:RosettaOptions, work_dir:str) -> str:
    ...
    # region == engines ==
    def build_rosetta_scripts_engine(self, protocol: RosettaScriptsProtocol, opts:RosettaOptions, work_dir:str, **kwargs):

        return RosettaScriptsEngine(self, protocol, opts, work_dir )
