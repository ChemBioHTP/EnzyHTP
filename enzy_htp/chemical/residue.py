...
from enzy_htp.core import InvalidResidueCode, _LOGGER

AA_LIST: List[str] = [
    "R", "H", "K", "D", "E", "S", "T", "N", "Q", "C", "G", "P", "A", "V", "I",
    "L", "M", "F", "Y", "W", "U"
]
...
RESIDUE_CTERMINAL_ATOM_LIST: Dict[str, List[str]] = {
    ...
    "ARG": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB2", "HB3", "CG", "HG2",
        "HG3", "CD", "HD2", "HD3", "NE", "HE", "CZ", "NH1", "HH11", "HH12",
        "NH2", "HH21", "HH22", "C", "O"
    ],
    "ASN": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB2", "HB3", "CG", "OD1",
        "ND2", "HD21", "HD22", "C", "O"
    ],
    "ASP": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB2", "HB3", "CG", "OD1",
    ...
    "CYS": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB2", "HB3", "SG", "HG", "C",
        "O"
    ],
    "CYX": [
    ...
    "HID": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB2", "HB3", "CG", "ND1",
        "HD1", "CE1", "HE1", "NE2", "CD2", "HD2", "C", "O"
    ],
    "HIE": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB2", "HB3", "CG", "ND1",
    ...
    "HIP": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB2", "HB3", "CG", "ND1",
        "HD1", "CE1", "HE1", "NE2", "HE2", "CD2", "HD2", "C", "O"
    ],
    "ILE": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB", "CG2", "HG21", "HG22",
        "HG23", "CG1", "HG12", "HG13", "CD1", "HD11", "HD12", "HD13", "C", "O"
    ],
    "LEU": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB2", "HB3", "CG", "HG",
        "CD1", "HD11", "HD12", "HD13", "CD2", "HD21", "HD22", "HD23", "C", "O"
    ],
    "LYS": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB2", "HB3", "CG", "HG2",
    ...
    "MET": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB2", "HB3", "CG", "HG2",
        "HG3", "SD", "CE", "HE1", "HE2", "HE3", "C", "O"
    ],
    "PHE": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB2", "HB3", "CG", "CD1",
        "HD1", "CE1", "HE1", "CZ", "HZ", "CE2", "HE2", "CD2", "HD2", "C", "O"
    ],
    "PRO": [
        "N", "H2", "H3", "CD", "HD2", "HD3", "CG", "HG2", "HG3", "CB", "HB2",
        "HB3", "CA", "HA", "C", "O"
    ],
    "SER": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB2", "HB3", "OG", "HG", "C",
        "O"
    ],
    "THR": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB", "CG2", "HG21", "HG22",
    ...
    "TYR": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB2", "HB3", "CG", "CD1",
        "HD1", "CE1", "HE1", "CZ", "OH", "HH", "CE2", "HE2", "CD2", "HD2", "C",
        "O"
    ],
    "VAL": [
        "N", "H1", "H2", "H3", "CA", "HA", "CB", "HB", "CG1", "HG11", "HG12",
        "HG13", "CG2", "HG21", "HG22", "HG23", "C", "O"
    ]
}
...
def one_letters_except(existing: str) -> List[str]:
    ...
    if existing not in ONE_LETTER_AA_MAPPER:
        raise InvalidResidueCode(
            f"{existing} is not a valid one letter amino acid")
