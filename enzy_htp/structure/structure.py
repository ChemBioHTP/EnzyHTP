...
def structure_from_pdb( fname : str ) -> Structure:
    ...
    # TODO: check if there are chain ids or not
    #for index, chain_str in enumerate(chains_str):
    #    if chain_str.strip() != "END" and chain_str.strip() != "":
            #Chain_index = chr(65 + index)  # Covert to ABC using ACSII mapping # CJ: this is good
            # Generate chains
...
#            print(
#                "Structure.fromPDB: final chain sequence: " + chain.id,
#                chain.get_chain_seq(Oneletter=1),
#            )
